package com.yanli.flink.scala.demo

import com.yanli.flink.java.config.KafkaConfig
import com.yanli.flink.scala.streaming.hbase.{HbaseReader, HbaseWriter}
import com.yanli.flink.scala.streaming.kafka.FlinkConnectKafka
